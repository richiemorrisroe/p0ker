...
#+BEGIN_SRC python :tangle deck.py :session
...
#+RESULTS:
| <__main__.Card | object | at | 0x7fc0c4944160> | <__main__.Card | object | at | 0x7fc0c49442b0> | <__main__.Card | object | at | 0x7fc0c48c9c50> | <__main__.Card | object | at | 0x7fc0c48c9a58> |
...
class FirstDeck:
    ...
    def __getitem__(self, position):
        return self._cards[position]
    def __repr__(self):
        fstring = "Cards remaining: {left}, top_card={tcard}"
        return fstring.format(left=len(self._cards), tcard=self._cards[0])
