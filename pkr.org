...
I'm going to recreate the enterity of deck.py within a folder called
deck
...
from pkr import Card, Suit, Rank, score_hand, make_straight
...
def test_score_straight_flush() -> None:
    straight_flush = [Card(Suit(1), Rank(7)), Card(Suit(1), Rank(8)),
                      Card(Suit(1), Rank(9)), Card(Suit(1), Rank(10)),
                      Card(Suit(1), Rank(11))]
    score, name = score_hand(straight_flush)
    assert name == 'STRAIGHT-FLUSH'

def test_score_three_of_a_kind() -> None:
    three_of_a_kind = [Card(Suit(1), Rank(14)), Card(Suit(2), Rank(14)),
            Card(Suit(3), Rank(14)), Card(Suit(1), Rank(3)),
            Card(Suit(1), Rank(5))]
    score, name = score_hand(three_of_a_kind)
    assert name == 'THREE-OF-A-KIND'

def test_score_twopair() -> None:
    twopair = [Card(Suit(1), Rank(8)), Card(Suit(2), Rank(8)),
            Card(Suit(1), Rank(2)), Card(Suit(2), Rank(2)),
            Card(Suit(3), Rank(5))]
