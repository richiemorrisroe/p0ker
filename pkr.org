...
* What is this?
  ...
  One day, if I have time [fn:1], I hope to get this working with my
...
***** DONE Wrap up all of these functions into a start round one, which returns players with Hands
...
***** DONE Make use of state object to decide action
**** Dealer Updates
...
- One round of betting done
***** discard cards
******* dealer handle new actions (RAISE vs CHECK), (CHECK vs BET)
***** get new cards
***** bet/call/fold in order
***** finish round
 - award pot
...
******* dealer handle dropping players and getting new cards
- don't take an action from players who have folded
***** DONE Add dealing of cards to start_round
**** Deck Object
***** DONE Move discard pile to deck object
...
- move logic in __init__ to separate function (validate_hand)
  
****** TODO Fix hand equality 
...
- define hand equality as hand1.score()==hand2.score()
****** TODO make sure that __iter__ and __next__ actually work (they look kinda weird)


** Design Thoughts :noexport:
...
[fn:1] i recently had a child, it's unlikely that I'll have this time 
# Local Variables:
